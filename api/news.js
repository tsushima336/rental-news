export default async function handler(req, res) {
  ...
  const feeds = [
    ...
    // Google News - 資格
    gn('宅地建物取引士 宅建 試験', 'news'),
    gn('宅建 合格 試験 2026', 'news'),
    gn('不動産鑑定士 試験 合格', 'news'),
    gn('管理業務主任者 試験', 'news'),
    gn('マンション管理士 試験', 'news'),
    gn('賃貸不動産経営管理士 試験', 'news'),
    gn('不動産 資格 試験 合格率', 'news'),
    gn('FP ファイナンシャルプランナー 不動産', 'news'),
    gn('土地家屋調査士 試験', 'news'),
    gn('不動産 資格 難易度 受験', 'news'),
  ];
  ...
  const relevantKeywords = [
    ...
    '住宅新報', '全国賃貸', 'R.E.port', '不動産流通', '賃貸管理', '不動産テック',
    'リノベーション', '民泊', 'シェアハウス', 'ワンルーム', '空き家', '建築基準',
    '重要事項説明', '仲介手数料', '保証人', '管理業務主任者', 'マンション管理士',
    '賃貸不動産経営管理士', '不動産鑑定士', '土地家屋調査士', '不動産 資格',
    'スマートホーム', 'IoT 賃貸', '不動産鑑定', '地価', '住宅ローン', 'プロパティ',
  ];
